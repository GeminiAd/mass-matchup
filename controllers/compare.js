...
const { getFriendsAndFriendRequests, authorizeUser, desperateMeasures, getFriendData, updateFriendDataIfNecessary, updateFriendOwnedGamesIfNecessary, getAllOwnedGamesForUser, getFriendOwnedGames, getSharedGames } = require('../utils/middleware');
...
router.get('/:id', authorizeUser, getFriendsAndFriendRequests, getFriendData, updateFriendDataIfNecessary, updateFriendOwnedGamesIfNecessary, getFriendOwnedGames, getAllOwnedGamesForUser, getSharedGames, async (req, res) => {
    //console.log(res.locals.sharedGames);
    
    res.render('compare-stats',
    {
        friends: res.locals.friends,
        friendRequests: res.locals.friendRequests,
        sharedGames: res.locals.sharedGames,
        user: {
...
router.get('/:id/stats/:appId', authorizeUser, getFriendsAndFriendRequests, getFriendData, updateFriendDataIfNecessary, updateFriendOwnedGamesIfNecessary, getFriendOwnedGames, getAllOwnedGamesForUser, getSharedGames, async (req, res) => {
